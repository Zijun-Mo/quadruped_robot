"""Package initializer for the unitree_rl_lab.unitree_rl_lab.tasks.locomotion.robots.go2.policy_evaluation namespace."""

import gymnasium as gym

gym.register(
    id="Unitree-Go2-Velocity-Policy-Evaluation-v0",
